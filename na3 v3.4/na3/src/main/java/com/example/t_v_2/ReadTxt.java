...
public class ReadTxt {
    ...
    public static int readint(String txtPath) {
        File file = new File(txtPath);
        int result;
    ...
    public static boolean writeHash(String txtPath, HashMap<String, Point> pp){
        ...
        try {
            ...
            for(String i: pp.keySet()){
                fileOutputStream.write((i + " " + pp.get(i).getX() + " " + pp.get(i).getY() + " " + "\n").getBytes());
            }
    ...
    public static boolean writeint(String txtPath, int x){
        FileOutputStream fileOutputStream = null;
        File file = new File(txtPath);
        try {
            if(file.exists()){
            ...
            fileOutputStream.write(String.valueOf(x).getBytes());
